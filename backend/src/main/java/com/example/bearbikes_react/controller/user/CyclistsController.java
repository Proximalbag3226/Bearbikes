...
import com.example.bearbikes_react.model.repository.user.CyclistsRepository;
...
public class CyclistsController {
    ...
    public ResponseEntity<List<Cyclist>> getRegisteredCyclists() {
        return ResponseEntity.ok(cyclistsRepository.getAll());
    }
